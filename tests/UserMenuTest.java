...
public class UserMenuTest extends BaseTest {
	...
	public void userMenuDropDown_TC06(Method name) throws IOException, InterruptedException {
		...
		Assert.assertTrue(ump.verifyFileUpload(driver, FileConstant.LOGIN_TESTDATA_FILE_PATH));
		BaseTest.test.info("Verified file upload");
		Assert.assertTrue(ump.verifyPhotoUpload(driver, FileConstant.PROFILE_PHOTO_FILE_PATH));
