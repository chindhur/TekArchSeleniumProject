...
public class LoginPage extends BasePage {
	...
	public void loginToApp(WebDriver driver) throws IOException {
		...
		if (CommonUtils.waitForElement(driver, username)) {
			username.sendKeys(ReadFile.readPropertiesFile(FileConstant.LOGIN_TESTDATA_FILE_PATH2, "username"));
			password.sendKeys(ReadFile.readPropertiesFile(FileConstant.LOGIN_TESTDATA_FILE_PATH2, "password"));
			loginButton.click();
