...
public class Tc18_TestStuckOpportunitiesReport extends BaseTest {
	
	@Test
	public void testStuckOpportunitiesReport() throws IOException {
		...
		op.stuckOpportunities.click();
		CommonUtils.waitForElement(driver, op.stuckOpportunities);
